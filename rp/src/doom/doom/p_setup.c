...
( int		episode,
  ...
  skill_t	skill)
{
    /* MD/DOOM: program this map's asset pack into flash if it is not the one
     * already there. Everything below reads the WHX in place. */
    extern void I_MD_LoadLevelPack(int ep, int mp);
    I_MD_LoadLevelPack(episode, map);
