...
/* MD/DOOM: the shared palettes point into the WHX; forget them when the pack
 * in flash changes so V_DrawPatchList re-resolves them. */
void V_ResetSharedPalettes(void) {
    memset(shared_palette8, 0, sizeof(shared_palette8));
}
