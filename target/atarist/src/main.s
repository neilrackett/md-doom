...
; Legacy: the original template boot UI filled only the first 8000 bytes
...
; screen. The native 4bpp FBDRV_INLINE copy replaced that loop; this
; constant is unused.
...
; version.inc is generated by target/atarist/Makefile from version.txt at
; build time and defines banner_txt, so the version the user reads always
; matches the build. Same arrangement as MD/Net.
	include version.inc
